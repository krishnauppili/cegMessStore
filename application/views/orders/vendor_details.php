   ...
   function deleteVendor(vendor_name){
         ...
         if(confirm('Do you really want to delete this Vendor ? This cannot be undone' )) {
            ...
            function addVendor(){
                  ...
                  //var vendor_code=$("#add_vendor_code").val();
                  ...
                  alert('Kindly fill all the details');
                        ...
                        //toSend["vendorCode"] = encodeURIComponent(vendor_code);
                                       ...
                                       dataToPrint += '<div class="row">'+
                                          '<div class="col s8 offset-s2">'+
                                             ...
                                             dataToPrint += '<table>';
                                                dataToPrint += '<tr>'+
                                                   '<th>'+
                                                      '<span class="blue-text">Vendor Name bb</span>'+
                                                      '</th>'+
                                                    '<!--<th>'+
                                                      ' <span class="blue-text">Vendor Code</span>'+
                                                      '</th>-->'+  
